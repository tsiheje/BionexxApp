          ...
          <>
            ...
            <View style={styles.profileSection}>
              <View style={styles.profileDetails}>
                ...
                <Text style={styles.profileValue}>
                  {cueilleurInfo.cueilleurPrincipal?.code_cp || "N/A"}
                </Text>
              </View>
              <View style={styles.profileDetails}>
                <Text style={styles.profileLabel}>Nom</Text>
                <Text style={styles.profileValue}>
                  {cueilleurInfo.cueilleurPrincipal?.nom_cp || "N/A"}
                </Text>
              </View>
              <View style={styles.profileDetails}>
                <Text style={styles.profileLabel}>Prénom</Text>
                <Text style={styles.profileValue}>
                  {cueilleurInfo.cueilleurPrincipal?.prenoms_cp || "N/A"}
                </Text>
              </View>
              <View style={styles.profileDetails}>
                <Text style={styles.profileLabel}>Surnom</Text>
                <Text style={styles.profileValue}>
                  {cueilleurInfo.cueilleurPrincipal?.surnoms_cp || "N/A"}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.statsCard}>
              <View style={styles.statItem}>
                <Text style={styles.statLabel}>Poids Livré</Text>
                <Text style={styles.statValue}>
                  {cueilleurInfo.cueilleurPrincipal?.cumul_reel || 0} kg
                </Text>
              </View>
            </View>
          </>
